...
if API_KEY:
    # Fix for PHI Gemini (important!)
    os.environ["GOOGLE_API_KEY"] = API_KEY

    # Fix for google.generativeai
...
st.header("This app is powered b Gemini")
...
if video_file:
    ...
    user_query = st.text_area(
        ...
        placeholder="Ask anything about the video content. The AI agent will analyze and gather additional conten",
            ...
            try:
                with st.spinner("Processing video and gathering insights..."):
                    ...
                    analysis_prompt = (
                        ...
                        Provide a detailed, user-friendly, and actionable response.user_query
                        """
                    )
